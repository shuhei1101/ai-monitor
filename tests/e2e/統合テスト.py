...
STORY_PR_BODY_WITH_TABLE = STORY_PR_BODY.replace(
    "- [ ] 単一ユースケース E2E テストコードを作成", "- [x] 単一ユースケース E2E テストコードを作成"
) + """
## 単一ユースケースシナリオテスト結果
...
EPIC_PR_BODY_WITH_TABLE = EPIC_PR_BODY.replace(
    "- [ ] 複合ユースケース E2E テストコードを作成", "- [x] 複合ユースケース E2E テストコードを作成"
) + """
## 複合ユースケースシナリオテスト結果
