...
def _cycle(mon_settings, label_settings, agent_models, mon_registry, prev, current):
...
def test_normal(gh_mon, tmux_calls, mon_settings, label_settings, agent_models, mon_registry):
    ...
    # 実行
    _cycle(mon_settings, label_settings, agent_models, mon_registry, prev, [])
    # 検証
...
def test_normal_when_system_is_top(gh_mon, tmux_calls, mon_settings, label_settings, agent_models, mon_registry):
...
def test_normal_when_story_is_top(gh_mon, tmux_calls, mon_settings, label_settings, agent_models, mon_registry):
...
def test_normal_when_subsystem_is_top(gh_mon, tmux_calls, mon_settings, label_settings, agent_models, mon_registry):
...
def test_normal_when_parent_remains(gh_mon, tmux_calls, mon_settings, label_settings, agent_models, mon_registry):
...
def test_normal_when_confirm_remains(gh_mon, tmux_calls, mon_settings, label_settings, agent_models, mon_registry):
