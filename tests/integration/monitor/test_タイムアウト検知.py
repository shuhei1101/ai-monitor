...
def test_normal_when_waiting(gh_mon, tmux_calls, mon_settings, label_settings, mon_registry):
...
def test_normal_when_session_gone(gh_mon, tmux_calls, mon_settings, label_settings, mon_registry):
