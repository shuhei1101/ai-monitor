...
def test_normal(gh, resp, api):
    ...
    # 実行
    res = api.create_child_issue(35, title="子", body="本文", labels=["layer:story"])
    # 検証
...
def test_error_when_link_fails(gh, resp, request_failed, api):
    ...
    with pytest.raises(RequestFailed):
        api.create_child_issue(35, title="子", body="本文")
