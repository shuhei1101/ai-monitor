...
from ai_monitor.mcp.models import CommentResult
...
def test_normal(gh, resp, api):
    ...
    # 実行
    res = api.comment(35, is_pr=False, sender="architect", receiver="shuhei1101", body="設計を更新しました。")
    # 検証
...
def test_error_when_api_error(gh, request_failed, api):
    ...
    with pytest.raises(RequestFailed):
        api.comment(35, is_pr=False, sender="architect", body="本文")
