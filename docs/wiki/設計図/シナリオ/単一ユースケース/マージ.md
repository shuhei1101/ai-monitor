...
sequenceDiagram
  ...
  MON->>GH: 親 story Issue に 完了報告コメント<br>（subsystem 完了・@story-conductor 宛） +<br>確認:story-conductor 付与
...
sequenceDiagram
  ...
  MON->>GH: 親 epic Issue に 完了報告コメント<br>（story 完了・@epic-conductor 宛） +<br>確認:epic-conductor 付与
...
sequenceDiagram
  ...
  MON->>REPO: worktree をローカルから削除
  MON->>GH: epic Issue を close
  MON->>GH: 親 system Issue に 完了報告コメント投稿 +<br>確認:system-conductor 付与
